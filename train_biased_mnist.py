...
from utils.utils import (AverageMeter, MultiDimAverageMeter, accuracy, load_model,
...
def parse_option():
    ...
    parser.add_argument('--color_classifier', type=str, default='./bias_capturing_classifiers/bcc_biased_mnist.pth')
